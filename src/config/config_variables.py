...
class DataIngestionConfig:
    def __init__(self,vars_config:VarsConfig):
        ...
        self.training_data_path:str = os.path.join(vars.OUT_DIR,vars.OUT_TRAIN_FILE_NAME)
        self.test_data_path:str = os.path.join(vars.OUT_DIR,vars.OUT_TEST_FILE_NAME)
        self.raw_data_path:str = os.path.join(vars.OUT_DIR,vars.OUT_RAW_FILE_NAME)
